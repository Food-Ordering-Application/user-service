...
export class modifyEntity1622620137683 implements MigrationInterface {
  name = 'modifyEntity1622620137683';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "paypal_payment" ADD "email" character varying`,
    );
    await queryRunner.query(
